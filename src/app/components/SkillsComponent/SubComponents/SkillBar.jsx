    ...
    <div className="flex items-center gap-4 py-2">
      ...
      <div className="flex-grow">
        ...
        <div className="bg-gray-800 border-2 border-blue-800 rounded-md h-2 w-32 overflow-hidden mt-2">
          <div className={`${style.contentInner} h-full rounded-sm bg-gradient-to-r from-stone-200 via-cyan-300 to-blue-500 `} style={{ width: progressPercentage, animation: "slideBar 2s ease"}} ></div>
        </div> 
      </div>
    </div>
  );
